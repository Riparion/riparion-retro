//! Taipan's persistence keys, on top of retro-kit's versioned localStorage.
...
const SAVE_KEY: &str = "taipan.save";
const SCORES_KEY: &str = "taipan.highscores";
/// v2: save moved to retro-kit's `{version, data}` envelope.
const SAVE_VERSION: u32 = 2;
const MAX_SCORES: usize = 10;

/// Resume a saved game, or start at the splash screen.
