//! Santa Paravia's persistence keys, on top of retro-kit's versioned localStorage.
...
const SAVE_KEY: &str = "santa-paravia.save";
const SCORES_KEY: &str = "santa-paravia.highscores";
const SAVE_VERSION: u32 = 1;
const MAX_SCORES: usize = 10;

/// Resume a saved reign, or start a fresh game at the title screen.
