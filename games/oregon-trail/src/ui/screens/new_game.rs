//! Name your family and rate your shooting before you outfit the wagon.
...
pub fn NewGame() -> Element {
    ...
    rsx! {
        div { class: "{SCREEN_CENTERED} gap-4",
            h2 { class: "text-center text-lg tracking-widest", "OUTFITTING IN INDEPENDENCE" }
            p { class: "text-center leading-snug",
                "What is your family's name? (Up to 22 characters.)"
            }
            input {
